...
revoke all on table public.player_access_requests from public;
revoke all on table public.player_access_requests from anon;
revoke all on table public.player_access_requests from authenticated;
